...
console.log("LeetCode 88. Merge Sorted Array");
...
console.log(`Example 1: The merged sorted array is: ${nums1}`);

(nums1 = [1]), (m = 1), (nums2 = []), (n = 0);
merge(nums1, m, nums2, n);
console.log(`Example 2: The merged sorted array is: ${nums1}`);

(nums1 = [0]), (m = 0), (nums2 = [1]), (n = 1);
merge(nums1, m, nums2, n);
console.log(`Example 3: The merged sorted array is: ${nums1}`);
